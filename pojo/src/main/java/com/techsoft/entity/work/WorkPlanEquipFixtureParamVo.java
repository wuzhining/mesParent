...
public class WorkPlanEquipFixtureParamVo extends WorkPlanEquipFixture {
	private static final long serialVersionUID = 5218156551311195465L;

	public WorkPlanEquipFixtureParamVo (){
	}
	
	public WorkPlanEquipFixtureParamVo(WorkPlanEquipFixture value) {
