...
@Controller
@RequestMapping("/equip/equipFixtureRepairItem")
public class EquipFixtureRepairItemController extends BaseController {
	@Autowired
	...
	public ModelAndView list(HttpServletRequest request) {
		...
		modelAndView.setViewName("equip/equipFixtureRepairItem-list");
		return modelAndView;
	}
