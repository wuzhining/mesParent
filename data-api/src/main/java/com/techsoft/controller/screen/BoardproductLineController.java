...
@Controller
@RequestMapping("/board/productLine")
public class BoardproductLineController extends BaseController {
	@Autowired
	...
	public ModelAndView list(HttpServletRequest request) {
		...
		modelAndView.setViewName("board/productLine-list");
		return modelAndView;
	}
	...
	public ReturnPageInfo listJson(HttpServletRequest request,
			ConfigCodeRuleParamVo configCodeRuleParamVo, Integer pageIndex) {
