...
public class PdaAlarmInforFlowController extends BaseController {
	...
	public ResultMessage getEquipCode(HttpServletRequest request, String equipCode,String factoryId) {
	...
	public ResultMessage selectAlarmType(HttpServletRequest request,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
		try {
	...
	public ResultMessage selectAlarmStatus(HttpServletRequest request,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
		try {
	...
	public ResultMessage selectdealResult(HttpServletRequest request,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
		try {
	...
	public ResultMessage getAlarmLevel(HttpServletRequest request,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
		try {
	...
	public ResultMessage getAlarmProblem(HttpServletRequest request,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
		try {
	...
	public ResultMessage getAlarmStatus(HttpServletRequest request,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
		try {
			ConfigDictionaryParamVo paramVo = new ConfigDictionaryParamVo();
			paramVo.setId(EnumAlarmStatus.NEWSPAPER_POLICE.getValue());			
	...
	@ResponseBody
	public ResultMessage alarmInforFlowSave(HttpServletRequest request,Long id,Long equipWorkId,Long problemId,Long alarmLevelId,Long alarmTypeDictId,Long statusDictId,String remark,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
		resultMessage.setIsSuccess(true);
	...
	public ResultMessage editAlarmInforFlow(HttpServletRequest request, Long id,String factoryId) {	
		ResultMessage resultMessage = new ResultMessage();
	...
	public ResultMessage getalarmInforFlowList(HttpServletRequest request, Long problemId, Long equipWorkId,Long alarmTypeDictId,Long statusDictId ,Long dealResultDictId,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
	...
	@ResponseBody
	public ResultMessage knotAlarmSave(HttpServletRequest request, Long id,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
		resultMessage.setIsSuccess(true);
		...
		if(!"".equals(id) && id != null){
			...
			alarmInforFlowParamVo.setStatusDictId(EnumAlarmStatus.IN_PROCESS.getValue());
		}else{
			resultMessage.setIsSuccess(false);
			resultMessage.addErr("id不能为空");
		}
	...
	@ResponseBody
	public ResultMessage analysisPQESave(HttpServletRequest request, Long id, Long problemId, Long alarmTypeDictId, String remark,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
		resultMessage.setIsSuccess(true);
		AlarmInforFlowParamVo alarmInforFlowParamVo = new AlarmInforFlowParamVo();
		alarmInforFlowParamVo.setModifyUserId(getLoginUserId(request));
		...
		alarmInforFlowParamVo.setStatusDictId(EnumAlarmStatus.FINISHED_PROCESSING.getValue());	
	...
	@ResponseBody
	public ResultMessage closeAlertSave(HttpServletRequest request,Long id, Long dealResultDictId, String remark,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
		resultMessage.setIsSuccess(true);
		AlarmInforFlowParamVo alarmInforFlowParamVo = new AlarmInforFlowParamVo();
		alarmInforFlowParamVo.setModifyUserId(getLoginUserId(request));
    	...
    	alarmInforFlowParamVo.setStatusDictId(EnumAlarmStatus.END.getValue());
