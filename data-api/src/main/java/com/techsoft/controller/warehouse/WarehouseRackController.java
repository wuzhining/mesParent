	...
	public ModelAndView edit(HttpServletRequest request, Long id) {
		...
		try {
			if (id != null) {
				...
				WarehouseArea warehouseArea = clientWarehouseAreaService.getVoByID(entity.getAreaId(), this.getCommonParam(request));
				modelAndView.addObject("warehouseArea", warehouseArea);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
