...
@Controller
@RequestMapping("/bill/billWarehouseSupplierItem")
public class BillWarehouseSupplierItemController extends BaseController {
	@Autowired
	...
	public ModelAndView list(HttpServletRequest request) {
		...
		modelAndView.setViewName("bill/billWarehouseSupplierItem-list");
		return modelAndView;
	}
	...
	public ModelAndView edit(HttpServletRequest request, Long id) {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("bill/billWarehouseSupplierItem-edit");
