...
public class StructProductionlineController extends BaseController {
	...
	@RequestMapping("/productionlineOpen")
	public ModelAndView productionlineOpen(HttpServletRequest request) {
		ModelAndView modelAndView = new ModelAndView();
		initData(modelAndView);
		modelAndView.setViewName("struct/structProductionline-Open");
		return modelAndView;
	}
}
