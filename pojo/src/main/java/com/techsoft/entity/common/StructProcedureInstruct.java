...
public class StructProcedureInstruct extends BaseEntity {
	private static final long serialVersionUID = -2980519398608547086L;


	public StructProcedureInstruct(){	
	}
	...
	private Long equipSpecsWorkId;	
	   
	private Integer quantityEquip;	
	...
	public Long getEquipSpecsWorkId() {
		return equipSpecsWorkId;
	}

	public void setEquipSpecsWorkId(Long equipSpecsWorkId) {
		this.equipSpecsWorkId = equipSpecsWorkId;
	}
                		
	public Integer getQuantityEquip() {
		return quantityEquip;
	}

	public void setQuantityEquip(Integer quantityEquip) {
