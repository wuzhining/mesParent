...
@Controller
@RequestMapping("/equip/equipWorkScrap")
public class EquipWorkScrapController extends BaseController {
	@Autowired
	...
	public ModelAndView list(HttpServletRequest request) {
		...
		modelAndView.setViewName("equip/equipWorkScrap-list");
		return modelAndView;
	}
	...
	public ModelAndView edit(HttpServletRequest request, Long id) {
		...
		try {
			...
			ConfigDictionary billTypeFixtureDict = clientConfigDictionaryService
					.selectById(EnumEquipBillType.SCRAP.getValue(), this.getCommonParam(null));
