...
@Controller
@RequestMapping("/stats/statsProductMaterial")
public class StatsProductMaterialController extends BaseController {
	@Autowired
	...
	public ModelAndView list(HttpServletRequest request) {
		...
		modelAndView.setViewName("stats/statsProductMaterial-list");
		return modelAndView;
	}
	...
	public ModelAndView edit(HttpServletRequest request, Long id) {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("stats/statsProductMaterial-edit");
		StatsProductMaterialVo entity = new StatsProductMaterialVo();
		try {
			if (id != null) {
				entity = clientStatsProductMaterialService.getVoByID(id, this.getCommonParam(request));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public ReturnPageInfo listJson(HttpServletRequest request,
			StatsProductMaterialParamVo statsProductMaterialParamVo, Integer pageIndex, Integer pageSize) {
		...
		try {
			...
			pageInfo = clientStatsProductMaterialService.selectPageVoByParamVo(
					statsProductMaterialParamVo, this.getCommonParam(request),
	...
	public ResultMessage save(HttpServletRequest request,
			StatsProductMaterialParamVo statsProductMaterialParamVo) {
		ResultMessage resultMessage = new ResultMessage();
	 
	    statsProductMaterialParamVo.setModifyUserId(getLoginUserId(request)); 
		resultMessage = clientStatsProductMaterialService.saveOrUpdate(statsProductMaterialParamVo,
