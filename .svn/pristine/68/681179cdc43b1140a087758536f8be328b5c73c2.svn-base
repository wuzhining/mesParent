...
public class PdaStockOfWarehouseController extends BaseController {
	...
	*/
	...
	public ResultMessage getwarehouseStock(HttpServletRequest request,Long warehouseId,Long locationId,Long materialId,String factoryId) {
	...
	*/
	...
	public ResultMessage getwarehouseStockDetail(HttpServletRequest request,Long warehouseId,Long locationId,Long materialId,String factoryId) {
	...
	*/
	...
	public ResultMessage getMaterialId(HttpServletRequest request,String barcode,String factoryId) {
	...
	public ResultMessage getLocation(HttpServletRequest request, String locationCode,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
	...
	public ResultMessage getWarehouse(HttpServletRequest request,String factoryId) {
		ResultMessage resultMessage = new ResultMessage();
