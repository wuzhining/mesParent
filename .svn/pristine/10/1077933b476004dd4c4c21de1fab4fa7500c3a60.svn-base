...
public class EquipClassesFixtureParamVo extends EquipClassesFixture {
	private static final long serialVersionUID = 1058597365421004129L;


	public EquipClassesFixtureParamVo (){
	}
	
	public EquipClassesFixtureParamVo(EquipClassesFixture value) {
