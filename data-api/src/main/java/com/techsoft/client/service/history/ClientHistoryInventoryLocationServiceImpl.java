...
public class ClientHistoryInventoryLocationServiceImpl extends BaseClientServiceImpl<HistoryInventoryLocation> implements ClientHistoryInventoryLocationService {
	...
	@com.alibaba.dubbo.config.annotation.Reference
	private ProductMainService productMainService;//物品
	@com.alibaba.dubbo.config.annotation.Reference
	private ProductMaterialService productMaterialService;//物品规格
	@com.alibaba.dubbo.config.annotation.Reference
	...
	@com.alibaba.dubbo.config.annotation.Reference
	private ConfigDictionaryService configDictionaryService;//数据字典
		...
		if (vo.getMaterialId() != null && vo.getMaterialId() > 0L) {
			...
			if (productMaterial != null) {
				...
				if(productMaterial.getProductTypeDictId() != null && productMaterial.getProductTypeDictId() > 0L){
					ConfigDictionary productType = configDictionaryService.deleteById(productMaterial.getProductTypeDictId(), commonParam);
					if(productType != null){
