...
(function(){
	...
	var equipAjax = function (){
		...
		$.ajax({
			url:"/board/equipWork/detail?factoryId="+1000067+"&equipCode="+"ECD004",//"ECD004",
			type: "post",
			dataType: "json",
	...
	var listAjax1 = function (){
		...
		$.ajax({
			url:"/board/equipWork/listScada?factoryId="+1000067+"&equipCode="+"ECD004",
			type: "post",
			dataType: "json",
			success: function (returnValue) {
				console.log(returnValue);
				...
				if(loadstaute == 1){
					...
					if(theight.offsetHeight > sheight.offsetHeight){
						clearInterval(a);
						var a = setInterval(doscroll, 2000);
					}
				}
...
var listAjax2 = function (){
		...
		$.ajax({
			url:"/board/equipWork/listWork?factoryId="+1000067+"&equipCode="+"ECD004",
			type: "post",
			dataType: "json",
			success: function (returnValue) {
