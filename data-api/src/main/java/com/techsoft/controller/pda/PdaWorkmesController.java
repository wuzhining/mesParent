...
public class PdaWorkmesController extends BaseController {
	...
	// 通过解绑载料器扫描仪进站
	@ResponseBody
	@RequestMapping("/enterByBindFixtureScanner")
	public ResultMessage enterByBindFixtureScanner(HttpServletRequest request, Long factoryId, String macaddress,
			String code) {

		return clientWorkTaskProcedureService.enterByBindFixtureScanner(getCommonParam(request), factoryId, macaddress,
				code);
	}

	// 通过解绑载料器扫描仪进站
	@ResponseBody
	@RequestMapping("/enterByUnbindFixtureScanner")
	public ResultMessage enterByUnbindFixtureScanner(HttpServletRequest request, Long factoryId, String macaddress,
			String equipFixtureCode) {

		return clientWorkTaskProcedureService.enterByUnbindFixtureScanner(getCommonParam(request), factoryId,
				macaddress, equipFixtureCode);
	}
	...
	// 通过组装扫描仪进站
	@ResponseBody
	@RequestMapping("/enterByAssembleScanner")
	public ResultMessage feedByAssembleScanner(HttpServletRequest request, Long factoryId, String macaddress,
			String barcodeList) {

		return clientWorkTaskProcedureService.enterByAssembleScanner(getCommonParam(request), factoryId, macaddress,
				barcodeList);
	}
	...
	public ResultMessage labeling(HttpServletRequest request, Long factoryId, String workstationCode, String equipCode,
			String barcodeRaw, String barcodeNewList) {

		return clientWorkTaskProcedureService.labeling(getCommonParam(request), factoryId, workstationCode, equipCode,
				barcodeRaw, barcodeNewList);
	}
