...
public class TaskPlanController extends BaseController {
	...
	public void initData(ModelAndView modelAndView) { 
		try {
			...
			List<StructProcess> processList = clientstructProcessService.selectListByParamVo(param,this.getCommonParam(null));
	...
	public ModelAndView list(HttpServletRequest request) {
		...
		//modelAndView.setViewName("bill/taskPlan-list");
		modelAndView.setViewName("work/workTaskPlan-list");
		return modelAndView;
	}
