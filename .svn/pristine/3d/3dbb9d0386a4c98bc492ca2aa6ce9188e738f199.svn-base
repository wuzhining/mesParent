...
@Controller
@RequestMapping("/work/workPlanEquip")
public class WorkPlanEquipController extends BaseController {
	@Autowired
	...
	public ModelAndView list(HttpServletRequest request) {
		...
		modelAndView.setViewName("work/workPlanEquip-list");
		return modelAndView;
	}
	...
	public ModelAndView edit(HttpServletRequest request, Long id) {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("work/workPlanEquip-edit");
