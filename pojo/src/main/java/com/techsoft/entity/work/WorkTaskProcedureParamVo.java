...
public class WorkTaskProcedureParamVo extends WorkTaskProcedure {
	private static final long serialVersionUID = 1781396672653291257L;

	public WorkTaskProcedureParamVo (){
	}
	
	public WorkTaskProcedureParamVo(WorkTaskProcedure value) {
