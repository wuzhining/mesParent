...
public class WarehouseAreaController extends BaseController {
	...
	public ModelAndView edit(HttpServletRequest request, Long id) {
		...
		try {
			...
			if (id != null) {
				...
				StructWarehouse structWarehouse = ClientStructWarehouseService.getVoByID(entity.getWarehouseId(), this.getCommonParam(request));
				modelAndView.addObject("structWarehouse", structWarehouse);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	@RequestMapping("/warehouseAreaOpen")
	public ModelAndView warehouseAreaOpen(HttpServletRequest request) {
		ModelAndView modelAndView = new ModelAndView();
		initData(modelAndView);
		modelAndView.setViewName("warehouse/warehouseArea-Open");
		return modelAndView;
	}
