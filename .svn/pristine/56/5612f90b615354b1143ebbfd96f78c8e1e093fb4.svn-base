	...
	function csbkbInfo(){
		ccfunc = function (){
			...
			var equipAjax = function (){
				$.ajax({
					url:"/board/equipWork/detail?factoryId="+1000067+"&equipCode="+"EQ0017",//"ECD004",
					type: "post",
					dataType: "json",
			...
			var listAjax1 = function (){
				$.ajax({
					url:"/board/equipWork/listScada?factoryId="+1000067+"&equipCode="+"EQ0017",
					type: "post",
					dataType: "json",
					success: function (returnValue) {
						console.log(returnValue);
...
var listAjax2 = function (){
		...
		$.ajax({
			url:"/board/equipWork/listWork?factoryId="+1000067+"&equipCode="+"EQ0017",
			type: "post",
			dataType: "json",
			success: function (returnValue) {
				if(returnValue.isSuccess == true){
