...
public class WorkPlanWorkstationParamVo extends WorkPlanWorkstation {
	private static final long serialVersionUID = -7129204498256827161L;

	public WorkPlanWorkstationParamVo (){
	}
	
	public WorkPlanWorkstationParamVo(WorkPlanWorkstation value) {
