...
public class AlarmInforFlowController extends BaseController {
	...
	public ResultMessage save(HttpServletRequest request,
		...
		ResultMessage resultMessage = new ResultMessage();
		 if(alarmInforFlowParamVo.getStatusDictId().equals(EnumAlarmStatus.NEWSPAPER_POLICE.getValue())){
			    //设置报警人
		    	alarmInforFlowParamVo.setAlarmUserId(getLoginUserId(request));
		    	alarmInforFlowParamVo.setAlarmTime(new Date()); 
	...
	public ResultMessage kontAlarmEdit(HttpServletRequest request,
	    ...
	    }else if(alarmInforFlowParamVo.getStatusDictId().equals(EnumAlarmStatus.IN_PROCESS.getValue())){
		    //设置PQE确人
	    ...
	    }else if(alarmInforFlowParamVo.getStatusDictId().equals(EnumAlarmStatus.FINISHED_PROCESSING.getValue())){
		    //设置关闭确人
