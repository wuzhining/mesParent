	...
	function csbkbInfo(){
		ccfunc = function (){
		       ...
		       Highcharts.chart('container1', {
		    	   ...
		    	   xAxis: {
		    		   categories: ['CH1 FREQ MAX','Battery Failure','POSTUUT'],//tm,
		    		   min : 0,
		    		   max: 2,//tm.length - 1
		    	   },
		    	   yAxis: {
		       ...
		       Highcharts.chart('container3', {
		    	   ...
		    	   series: [{
		    		   name: '<span>运动稼动率</span>',
		    		   data: [40,20,30,50,20,10]//Aarr
		    		   
		    	   }, {
		    		   name: '<span>性能稼动率</span>',
		    		   data:[40,20,30,50,20,10]//Barr
		    		   
		    	   }, {
		    		   name: '<span>直通率</span>',
		    		   data: [40,20,30,50,20,10]//Carr
		    		   
		    	   }, {
		    		   name: '<span>OEE</span>',
		    		   data:[40,20,30,50,20,10]//Darr
