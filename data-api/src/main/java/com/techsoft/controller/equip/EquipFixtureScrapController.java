...
@Controller
@RequestMapping("/equip/equipFixtureScrap")
public class EquipFixtureScrapController extends BaseController {
	@Autowired
	...
	public ModelAndView list(HttpServletRequest request) {
		...
		modelAndView.setViewName("equip/equipFixtureScrap-list");
		return modelAndView;
	}
	...
	public ModelAndView edit(HttpServletRequest request, Long id) {
		...
		try {
			...
			//拿到报废单据类型
			ConfigDictionary billTypeFixtureDict = clientConfigDictionaryService.selectById(EnumEquipBillType.SCRAP.getValue(), this.getCommonParam(null));
			...
			ConfigDictionary billStatusFixtureDict = clientConfigDictionaryService
					.selectById(10445L, this.getCommonParam(null));
