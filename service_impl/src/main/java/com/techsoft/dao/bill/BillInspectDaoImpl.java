...
/*		if (value.getInspectResultDictId() == null) {
	...
	@Override
	public void updateInspectBillStatus(BillInspectParamVo billInspectVo, CommonParam commonParam)
			throws BusinessException, SQLException {
		...
		try {
		    ...
		    item.setInspectStatusDictId(EnumBillStatus.FINISHED.getValue());
