...
public final class Md5Token {
	...
	public static String StringgetconvertMD5(String inStr) {
	...
	public static void main(String[] args) {
		System.out.println( Md5Token.getInstance().getLongToken("tanyekai"));
		
		System.out.println("tanyekai".hashCode());
