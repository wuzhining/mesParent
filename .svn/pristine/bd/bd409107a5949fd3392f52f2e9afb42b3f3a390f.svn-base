...
public class WorkPlanEquipParamVo extends WorkPlanEquip {
	private static final long serialVersionUID = 8864674517832732049L;

	public WorkPlanEquipParamVo (){
	}
	
	public WorkPlanEquipParamVo(WorkPlanEquip value) {
