...
*/
@Service
public class BillWarehouseSaleReturnServiceImpl extends BaseServiceImpl<BillWarehouse> implements BillWarehouseSaleReturnService {
	@Autowired
	...
	@Override
	public ResultMessage barcodeSaleReturn(List<BarcodeMain> list, CommonParam commonParam)
			throws BusinessException, SQLException {
		    ResultMessage resultMessage = new ResultMessage(); 
		    List<BillWarehouseItem> itemReturnList = new ArrayList<>();
		    List<BillWarehouseItem> itemInputList = new ArrayList<>();
			String billReturnCode = configCodeRuleDao.createCode(BillWarehouse.class.getName(),EnumBillType.BILL_TYPE_WAREHOUSE_REJECT_CUSTOMER.getValue(), null,commonParam);
			...
			billReturn.setBillTypeDictId(EnumBillType.BILL_TYPE_WAREHOUSE_REJECT_CUSTOMER.getValue());
			...
			//新增退料单新建、处理中状态历史表
			historyBillStatusDao.billHistoryInsert(EnumBillType.BILL_TYPE_WAREHOUSE_REJECT_CUSTOMER.getValue(), EnumBillStatus.NEW.getValue(), billRet.getId(),billReturnCode, commonParam);
			historyBillStatusDao.billHistoryInsert(EnumBillType.BILL_TYPE_WAREHOUSE_REJECT_CUSTOMER.getValue(), EnumBillStatus.DOING.getValue(), billRet.getId(), billReturnCode,commonParam);
			...
			billReturn.setFromBillCode(billReturnCode);
			...
			for (BarcodeMain barcodeMain : barcodeList) {
				...
				trackBarcodeItem.setBillTypeDictId(EnumBillType.BILL_TYPE_WAREHOUSE_REJECT_CUSTOMER.getValue());
