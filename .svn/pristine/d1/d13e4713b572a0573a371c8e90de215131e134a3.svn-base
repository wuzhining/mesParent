...
@Controller
@RequestMapping("/firm/firmDepartment")
public class FirmDepartmentController extends BaseController {
	@Autowired
	...
	public ModelAndView list(HttpServletRequest request) {
		...
		modelAndView.setViewName("firm/firmDepartment-list");
		return modelAndView;
	}
	...
	@RequestMapping("/firmDepartmentOpen")
	public ModelAndView firmDepartmentOpen(HttpServletRequest request) {
		ModelAndView modelAndView = new ModelAndView();
		initData(modelAndView);
		modelAndView.setViewName("firm/firmDepartment-Open");
		return modelAndView;
	}
