...
@Controller
@RequestMapping("/equip/equipFixtureRepair")
public class EquipFixtureRepairController extends BaseController {
	@Autowired
	...
	public ModelAndView list(HttpServletRequest request) {
		...
		modelAndView.setViewName("equip/equipFixtureRepair-list");
		return modelAndView;
	}
