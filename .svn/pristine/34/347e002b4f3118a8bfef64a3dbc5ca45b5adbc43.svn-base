...
@Controller
@RequestMapping("/struct/structWorkCalendar")
public class StructWorkCalendarController extends BaseController {
	@Autowired
	...
	public ModelAndView list(HttpServletRequest request) {
		...
		modelAndView.setViewName("struct/structWorkCalendar-list");
		return modelAndView;
	}
	...
	public ModelAndView edit(HttpServletRequest request, Long id) {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("struct/structWorkCalendar-edit");
